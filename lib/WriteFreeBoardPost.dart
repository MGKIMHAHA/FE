...
class WriteFreeBoardPost extends StatefulWidget {
  final bool isEditing;
  final Map<String, dynamic>? post;  // 수정할 게시글 데이터

  const WriteFreeBoardPost({
    super.key,
  ...
  @override
  State<WriteFreeBoardPost> createState() => _WriteFreeBoardPostState();
}

class _WriteFreeBoardPostState extends State<WriteFreeBoardPost> {
  ...
  Future<void> _submitPost() async {
    ...
    try {
      ...
      for (XFile image in _images) {
        final String fileName = 'freeboard_${DateTime.now().millisecondsSinceEpoch}_${imageUrls.length}.${image.path.split('.').last}';
