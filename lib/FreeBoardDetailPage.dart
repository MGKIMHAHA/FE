...
class _FreeBoardDetailPageState extends State<FreeBoardDetailPage> {
  ...
  Future<void> _loadComments() async {
    try {
      final comments = await ApiService.getComments(widget.postId, BoardType.freeboard);
      if (mounted) {
        setState(() {
          _comments = comments;
        });
  ...
  Future<void> _toggleLike() async {
    try {
      ...
      if (_isLiked) {
        ...
        await _supabase.rpc('increment_freeboard_like_count', params: {
        ...
        await _supabase.rpc('decrement_freeboard_like_count', params: {
          'post_id_param': widget.postId
        });
      }
    } catch (e) {
